...
/**
 * Esta clase es la pantalla donde se muestran los músicos y se pueden borrar de la lista.
...
public class Borrar extends AppCompatActivity {
    ...
    /**
     * Borra un músico de la base de datos según el nombre proporcionado.
     *
     * @param musico El nombre del músico a borrar.
     */
